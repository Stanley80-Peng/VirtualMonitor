...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_filepath.setGeometry(QtCore.QRect(21, 35, 191, 21))
        ...
        self.lineEdit_date.setGeometry(QtCore.QRect(120, 121, 81, 21))
        self.lineEdit_date.setObjectName("lineEdit_date")
        self.label_date = QtWidgets.QLabel(Form)
        self.label_date.setGeometry(QtCore.QRect(40, 123, 71, 16))
        self.label_date.setObjectName("label_date")
        self.button_start = QtWidgets.QPushButton(Form)
        self.button_start.setGeometry(QtCore.QRect(30, 152, 126, 41))
        ...
        self.button_pause.setGeometry(QtCore.QRect(158, 152, 126, 41))
        self.button_pause.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.button_pause.setObjectName("button_pause")
        self.label_speed = QtWidgets.QLabel(Form)
        self.label_speed.setGeometry(QtCore.QRect(136, 193, 60, 16))
        self.label_speed.setObjectName("label_speed")
        self.slider_speed = QtWidgets.QSlider(Form)
        self.slider_speed.setGeometry(QtCore.QRect(39, 213, 231, 22))
        ...
        self.label_multiple.setGeometry(QtCore.QRect(40, 238, 241, 16))
        self.label_multiple.setObjectName("label_multiple")
        self.button_forw15 = QtWidgets.QPushButton(Form)
        self.button_forw15.setGeometry(QtCore.QRect(12, 261, 91, 41))
        ...
        self.button_forw10.setGeometry(QtCore.QRect(107, 261, 91, 41))
        ...
        self.button_forw1h.setGeometry(QtCore.QRect(200, 261, 91, 41))
        ...
        self.button_back15.setGeometry(QtCore.QRect(12, 301, 91, 41))
        ...
        self.button_back3.setGeometry(QtCore.QRect(107, 301, 91, 41))
        ...
        self.button_back30.setGeometry(QtCore.QRect(200, 301, 91, 41))
        ...
        self.button_clear.setGeometry(QtCore.QRect(200, 341, 91, 41))
        ...
        self.button_stamp.setGeometry(QtCore.QRect(107, 341, 91, 41))
        ...
        self.radio_planner.setGeometry(QtCore.QRect(40, 65, 100, 20))
        self.radio_planner.setObjectName("radio_planner")
        self.radio_shadow = QtWidgets.QRadioButton(Form)
        self.radio_shadow.setGeometry(QtCore.QRect(120, 65, 121, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.button_back15.setText(_translate("Form", "<<3sec"))
