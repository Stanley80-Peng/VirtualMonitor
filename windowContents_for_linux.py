...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.button_jump.setGeometry(QtCore.QRect(210, 370, 71, 31))
        self.button_jump.setObjectName("button_jump")
        self.label_jump = QtWidgets.QLabel(Form)
        self.label_jump.setGeometry(QtCore.QRect(20, 377, 81, 16))
        self.label_jump.setObjectName("label_jump")
        self.lineEdit_jump = QtWidgets.QLineEdit(Form)
        self.lineEdit_jump.setGeometry(QtCore.QRect(140, 375, 61, 21))
